			...
			<div id="content">
				...
				<div class="container-fluid">
				  ...
				  <div class="card shadow mb-4">
					  ...
					  <div class="card-body">
						  <?= form_open('penyakit/ubah/' . $penyakit->id) ?>
							<div class="form-row align-items-center">
								<div class="col-sm-12 col-md-12 col-xl-12 col-lg-12">
									<div class="col-sm-12 my-1">
										...
										<?= form_input('nama_penyakit', form_error('nama_penyakit') ? set_value('nama_penyakit') : $penyakit->nama_penyakit, ['class' => 'form-control', 'autocomplete' => 'off']); ?>
										</div>
										...
										<?= form_input('jenis_penyakit', form_error('jenis_penyakit') ? set_value('jenis_penyakit') : $penyakit->jenis_penyakit, ['class' => 'form-control', 'autocomplete' => 'off']); ?>
										</div>
										...
										<div class="input-group mt-2">
											...
											<?= form_input('penanganan', form_error('penanganan') ? set_value('penanganan') : $penyakit->penanganan, ['class' => 'form-control', 'autocomplete' => 'off']); ?>
										</div>
