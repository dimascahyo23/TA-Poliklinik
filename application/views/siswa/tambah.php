								...
								<div class="col-sm-12 col-md-12 col-xl-12 col-lg-12">
									<div class="col-sm-12 my-1">
										<div class="input-group">
											...
											<?= form_input('nama_siswa', set_value('nama_siswa'), ['class' => 'form-control', 'autocomplete' => 'off']); ?>
										</div>
										...
										<div class="input-group mt-2">
											...
											<?= form_input('alamat_siswa', set_value('alamat_siswa'), ['class' => 'form-control', 'autocomplete' => 'off']); ?>
										</div>
										...
										<div class="input-group mt-2">
											...
											<input type="number" name="nis_siswa" class="form-control" value="<?= set_value('nis_siswa') ?>">
										</div>
