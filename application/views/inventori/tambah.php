								...
								<div class="col-sm-12 col-md-12 col-xl-12 col-lg-12">
									<div class="col-sm-12 my-1">
										<div class="input-group">
											...
											<?= form_input('nama_barang', set_value('nama_barang'), ['class' => 'form-control', 'autocomplete' => 'off']); ?>
										</div>
										...
										<div class="input-group mt-3">
											...
											<input type="number" name="total_barang" class="form-control" autocomplete="off" value="<?= set_value('total_barang') ?>">
										</div>
										...
										<div class="input-group mt-3">
											...
											<?= form_dropdown('kondisi_barang', [NULL => 'Pilih Kondisi Barang', 'Bagus' => 'Bagus', 'Rusak' => 'Rusak'], set_value('kondisi_barang'), ['class' => 'form-control', 'autocomplete' => 'off']); ?>
										</div>
